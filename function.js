				...
				if (shift.mastershiftStart && shift.mastershiftEnd && startDateTime && endDateTime) {
					...
					if (shiftStartMs !== masterStartMs || shiftEndMs !== masterEndMs) {
						differentTimeIndicator =
							'<span class="shift-indicator-tooltip different-time-indicator" style="padding-left: 0.2rem;" data-tooltip="Different time to master shift" aria-label="Different time to master shift">◑</span>';
					}
				}
